...
<body>
		...
		<div class="container">
			...
			<form action=" " method="POST" id="update-form"
				...
				<button type="button" class="back-btn"
					onclick="window.location.href='view_all_doctors.jsp?admin_name=<%=request.getParameter("admin_name")%>'">Back</button>
			</form>
		</div>
	</div>
	...
	function validateFile() {
        ...
        document.getElementById('update-form').addEventListener('submit', function(event) {
            ...
            form.action = '../doctor_data_update?id=<%=id%>&&name=<%=request.getParameter("admin_name")%>&&call_name=<%="admin"%>';
            // Submit the form
