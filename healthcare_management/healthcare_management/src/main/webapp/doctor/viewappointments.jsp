				...
				<table>
					...
					<tbody>
						<tr>
							...
							<td class="tdcenter"><a
								href="appointment_details.jsp?doctor_id=<%=request.getParameter("doctor_id")%>&&doctor_name=<%=request.getParameter("doctor_name")%>&&appointment_id=<%=resultSet.getString(11)%>">view...</a></td>
						</tr>
					</tbody>
					<%
					}
